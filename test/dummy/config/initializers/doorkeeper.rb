...
Doorkeeper.configure do # rubocop:disable Metrics/BlockLength
  ...
  resource_owner_authenticator do
    if doorkeeper_token&.acceptable?('user')
      LinkedRails.user_class.find_by(id: doorkeeper_token.resource_owner_id)
...
Doorkeeper::JWT.configure do # rubocop:disable Metrics/BlockLength
  ...
  token_payload do |opts|
    user =
      if opts[:scopes].include?('guest')
        ...
        LinkedRails.user_class.find(opts[:resource_owner_id])
      end
